...
namespace CompanyApplication.Controller
{
    public class EmployeeController
    {
        ...
        private EmployeeService _companyservice { get; }
        ...
        EnterOption: Helper.WriteToConsole(ConsoleColor.Cyan, "Add name for employee :");
            ...
            int employeeAge;
            bool isTrue = int.TryParse(Age, out employeeAge);
            ...
            if (isTrueAge && isTrueId)
            {
                ...
                if (result! = null)
                {
                    ...
                    Helper.WriteToConsole(ConsoleColor.Green, $ "ID : {employee.Id}) - Name : {employee.Name} - Surname : {employee.Company.Name} created");
        ...
        public void GetAllById()
        {
            ...
            foreach (var item in result)
            {
                ...
                {
                    Helper.WriteToConsole(ConsoleColor.Green, $"ID:{item.Id} - Name: {item.Name} - Surname: {item.Surname}  CompanyName- {item.Company.Name}");
                }
